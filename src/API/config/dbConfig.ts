...
const metricsDBClient = new Client({
...
// Define the schema and table location for the metrics database
...
export const connectDatabases = async () => {
  try {
    ...
    await metricsDBClient.connect(); // Connect to metrics database
  } catch (error) {
...
export { userDBClient, metricsDBClient };