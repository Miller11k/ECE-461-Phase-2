...
import { saveBase64AsZip, extractPackageJsonFromZip, } from '../../helpers/zipHelper.js';
...
router.post('/', async (req, res) => {
    try {
        ...
        const result = await userDBClient.query(`SELECT * FROM public.users WHERE username = $1`, [username]);
        ...
        if (Content) {
            ...
            console.log(`SELECT * FROM ${packageDB} WHERE "Name" = $1 AND "Version" = $2`, [packageName, packageVersion]);
       ...
       VALUES ($1, $2, $3, $4, $5, $6)`, [packageID, packageName, packageVersion, repoLink, isInternal, s3Link]);
