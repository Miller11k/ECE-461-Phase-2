...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        const result = await userDBClient.query(`SELECT salt, password, tokens FROM ${employeeDB} WHERE username = $1`, [username]);
        ...
        await userDBClient.query(`UPDATE ${employeeDB} SET tokens = array_append(tokens, $1) WHERE username = $2`, [newToken, username]);
