...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        const result = await userDBClient.query(`SELECT first_name, last_name, is_admin, salt, password, tokens FROM ${employeeDB} WHERE username = $1`, [username]);
        ...
        await userDBClient.query(`UPDATE ${employeeDB} SET password = $1, "X-Authorization" = $2, salt = $3 WHERE username = $4`, [newHashedPassword, newSalt, username]
