...
router.delete('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, token, result, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, dbConfig_js_1.userDBClient.query("UPDATE ".concat(dbConfig_js_1.employeeDB, " SET tokens = array_remove(tokens, $1) WHERE username = $2"), [token, username])];
            case 2:
                result = _b.sent();
