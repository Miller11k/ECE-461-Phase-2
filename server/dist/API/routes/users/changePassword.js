...
router.post('/', async (req, res) => {
    try {
        ...
        const result = await userDBClient.query(`SELECT salt, password FROM ${employeeDB} WHERE username = $1`, [username]);
        ...
        const updateResult = await userDBClient.query(`UPDATE ${employeeDB} SET password = $1, salt = $2 WHERE username = $3`, [newHashedPassword, newSalt, username]);
